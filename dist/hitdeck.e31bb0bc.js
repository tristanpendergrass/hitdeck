...
var author$project$Main$defaultMat = {
	deck: {cards: _List_Nil, id: 2},
	discard: {cards: _List_Nil, id: 3},
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Draw':
				var mat = msg.a;
				var _n2 = mat.deck.cards;
				if (!_n2.b) {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var firstCard = _n2.a;
					var restOfCards = _n2.b;
					var oldDiscard = mat.discard;
					var oldDeck = mat.deck;
					var _n3 = A2(
						elm$random$Random$step,
...
},{"./src/Main.elm":"src/Main.elm"}],"../../.nvm/versions/node/v10.14.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
