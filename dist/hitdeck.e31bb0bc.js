...
var $author$project$Main$GenerateSeed = function (a) {
	return {$: 'GenerateSeed', a: a};
};
var $author$project$Main$Crit = {$: 'Crit'};
var $author$project$Main$Default = {$: 'Default'};
var $author$project$Main$MinusOne = {$: 'MinusOne'};
var $author$project$Main$MinusTwo = {$: 'MinusTwo'};
...
var $author$project$Main$defaultMat = {
	deck: {
		cards: _List_fromArray(
			[
				{cardType: $author$project$Main$Zero, id: 11},
				{cardType: $author$project$Main$One, id: 12},
				{cardType: $author$project$Main$MinusOne, id: 13},
				{cardType: $author$project$Main$Two, id: 14},
				{cardType: $author$project$Main$MinusTwo, id: 15},
				{cardType: $author$project$Main$Crit, id: 16},
				{cardType: $author$project$Main$Null, id: 17},
				{cardType: $author$project$Main$Zero, id: 18}
			]),
		id: 10
	},
	discard: {cards: _List_Nil, id: 20},
	editState: $author$project$Main$Default,
	id: 2
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			mats: _List_fromArray(
				[$author$project$Main$defaultMat]),
			nonce: 41,
			seed: $elm$random$Random$initialSeed(0)
		},
		A2($elm$core$Task$perform, $author$project$Main$GenerateSeed, $elm$time$Time$now));
};
...
var $author$project$Main$Card = F2(
	function (id, cardType) {
		return {cardType: cardType, id: id};
	});
...
var $author$project$Main$replace = F2(
	function (oldA, newA) {
		return $elm$core$List$map(
			function (ax) {
				return _Utils_eq(ax, oldA) ? newA : ax;
			});
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Reshuffle':
				var mat = msg.a;
				var oldDiscard = mat.discard;
				var oldDeck = mat.deck;
				var newDiscard = _Utils_update(
					oldDiscard,
					{cards: _List_Nil});
				var allCards = $elm$core$List$concat(
					_List_fromArray(
						[mat.deck.cards, mat.discard.cards]));
				var _v1 = A2(
					$elm$random$Random$step,
					$elm_community$random_extra$Random$List$shuffle(allCards),
					model.seed);
				var shuffledCards = _v1.a;
				var newSeed = _v1.b;
				var newDeck = _Utils_update(
					oldDeck,
					{cards: shuffledCards});
				var newMat = _Utils_update(
					mat,
					{deck: newDeck, discard: newDiscard});
				var newMats = A3($author$project$Main$replace, mat, newMat, model.mats);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{mats: newMats, seed: newSeed}),
					$elm$core$Platform$Cmd$none);
			case 'Draw':
				var mat = msg.a;
				var _v2 = mat.deck.cards;
				if (!_v2.b) {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var firstCard = _v2.a;
					var restOfCards = _v2.b;
					var oldDiscard = mat.discard;
					var oldDeck = mat.deck;
					var _v3 = A2(
						$elm$random$Random$step,
						A2($elm$random$Random$uniform, firstCard, restOfCards),
						model.seed);
					var drawnCard = _v3.a;
					var newSeed = _v3.b;
					var newDeck = _Utils_update(
						oldDeck,
						{
							cards: A2(
								...
								$elm$core$Basics$neq(drawnCard),
								oldDeck.cards)
						});
					var newDiscard = _Utils_update(
						oldDiscard,
						{
							cards: A2($elm$core$List$cons, drawnCard, oldDiscard.cards)
						});
					var newMat = _Utils_update(
						mat,
						{deck: newDeck, discard: newDiscard});
			...
			case 'AddCard':
				...
				var newDeck = _Utils_update(
					oldDeck,
					{
						cards: A2(
							$elm$core$List$cons,
							A2($author$project$Main$Card, model.nonce, cardType),
							oldDeck.cards)
					});
				var newMat = _Utils_update(
					mat,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{mats: newMats, nonce: model.nonce + 1}),
					$elm$core$Platform$Cmd$none);
			case 'RemoveCard':
				var deck = msg.a;
				var mat = msg.b;
				...
				var newDeck = _Utils_update(
					deck,
					{
						cards: A2($elm_community$list_extra$List$Extra$remove, card, deck.cards)
					});
				var newMat = _Utils_update(
					mat,
					{deck: newDeck});
			...
			case 'ToggleMatEdit':
				...
				var newMat = _Utils_update(
					mat,
					{
						editState: _Utils_eq(mat.editState, $author$project$Main$Default) ? $author$project$Main$Editing : $author$project$Main$Default
					});
				var newMats = A3($author$project$Main$replace, mat, newMat, model.mats);
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var newMat = {
					deck: {cards: _List_Nil, id: model.nonce + 1},
					discard: {cards: _List_Nil, id: model.nonce + 2},
					editState: $author$project$Main$Default,
					id: model.nonce
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							mats: A2($elm$core$List$cons, newMat, model.mats),
							nonce: model.nonce + 3
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$AddMat = {$: 'AddMat'};
var $elm$html$Html$hr = _VirtualDom_node('hr');
var $author$project$Main$Draw = function (a) {
	return {$: 'Draw', a: a};
};
var $author$project$Main$Reshuffle = function (a) {
	return {$: 'Reshuffle', a: a};
};
var $author$project$Main$ToggleMatEdit = function (a) {
	return {$: 'ToggleMatEdit', a: a};
};
var $author$project$Main$RemoveCard = F3(
	function (a, b, c) {
		return {$: 'RemoveCard', a: a, b: b, c: c};
	});
var $author$project$Main$cardRow = F2(
	function (mat, card) {
		var _v0 = card.cardType;
		switch (_v0.$) {
			case 'Zero':
				return A2(
					$elm$html$Html$li,
...
var $author$project$Main$renderAddCard = F2(
	function (mat, cardType) {
		var label = function () {
			switch (cardType.$) {
				case 'Zero':
					return '+Zero';
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(
					A2($author$project$Main$AddCard, mat, cardType))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(label)
...
var $author$project$Main$renderMat = function (mat) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$ToggleMatEdit(mat))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Toggle Editing')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						A2($author$project$Main$renderAddCard, mat, $author$project$Main$One),
						A2($author$project$Main$renderAddCard, mat, $author$project$Main$MinusOne),
						A2($author$project$Main$renderAddCard, mat, $author$project$Main$Two),
						A2($author$project$Main$renderAddCard, mat, $author$project$Main$MinusTwo),
						A2($author$project$Main$renderAddCard, mat, $author$project$Main$Crit),
						A2($author$project$Main$renderAddCard, mat, $author$project$Main$Null)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$Reshuffle(mat))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Reshuffle')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$cardRow(mat),
					mat.deck.cards)),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Drawn cards:')
					])),
				A2(
				$elm$html$Html$ul,
				_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$AddMat)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Add Mat')
					])),
				A2($elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$renderMat, model.mats))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Card":{"args":[],"type":"{ id : Main.Id, cardType : Main.CardType }"},"Main.Id":{"args":[],"type":"Basics.Int"},"Main.Mat":{"args":[],"type":"{ id : Main.Id, deck : Main.Pile, discard : Main.Pile, editState : Main.EditState }"},"Main.Pile":{"args":[],"type":"{ id : Main.Id, cards : List.List Main.Card }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GenerateSeed":["Time.Posix"],"Reshuffle":["Main.Mat"],"Draw":["Main.Mat"],"AddCard":["Main.Mat","Main.CardType"],"RemoveCard":["Main.Pile","Main.Mat","Main.Card"],"ToggleMatEdit":["Main.Mat"],"AddMat":[]}},"Main.CardType":{"args":[],"tags":{"Zero":[],"One":[],"MinusOne":[],"Two":[],"MinusTwo":[],"Crit":[],"Null":[]}},"Main.EditState":{"args":[],"tags":{"Default":[],"Editing":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});
...
},{"./src/Main.elm":"src/Main.elm"}],"../../Users/Tristan/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../Users/Tristan/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/hitdeck.e31bb0bc.js.map